    ...
    if (result.success == true) {
      if (result.message == "Registration Successfull") {
        ...
        window.location.assign(
          "http://127.0.0.1:3000/CSE-326/CA%203/Food%20Donation/Front-End/home.html"
        );
      }
    } else {
      form.reset();
...
// Home Page
let donate_Button = document.getElementById("donate-button");

async function donate_Us_Button() {
  window.location.assign(
    "http://127.0.0.1:3000/CSE-326/CA%203/Food%20Donation/donate.html"
  );
}
